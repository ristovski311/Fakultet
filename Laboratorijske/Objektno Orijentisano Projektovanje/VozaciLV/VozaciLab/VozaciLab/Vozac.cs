...
namespace VozaciLab
{
    public partial class Vozac : Form
    {
        ...
        public void UcitajKomponente()
        {
            ...
            pcbAutomobil.Image = Image.FromFile(v.SlikaAutomobila);
        }
        ...
        public bool Validacija()
        {
            ...
            if (pcbAutomobil.Image == null)
            {
                MessageBox.Show("Izaberite sliku auta!", "Greska!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        ...
        private void btnDodajSlikuAutomobila_Click(object sender, EventArgs e)
        {
            OpenFileDialog ofd = new OpenFileDialog();
            ofd.Filter = "PNG|*.png|JPEG|*.jpeg";
            ...
            {
                String fileName = ofd.FileName;
                v.SlikaAutomobila = fileName;
                Image img = Image.FromFile(fileName);
                pcbAutomobil.Image = img;
            }
        }
    }
}
