...
namespace Podaci
{
    public class Vozac
    {
        ...
        public Vozac(string ime, string prezime, DateTime datRodjenja, string brojDozvole, DateTime dozvolaOd, DateTime dozvolaDo, string mestoIzdavanja, char pol, string slika, string slikaAuta, List<Kategorija> kategorije, List<Zabrana> zabrane)
        {
            this.ime = ime;
            ...
            this.pol = pol;
            this.slika = slika;
            this.SlikaAutomobila = slikaAuta;
        ...
        public Vozac(Vozac v)
        {
            ...
            this.Pol = v.Pol;
            this.Slika = v.Slika;
            this.slikaAutomobila = v.SlikaAutomobila;
        ...
        public string SlikaAutomobila
        {
            get { return slikaAutomobila; }
            set { slikaAutomobila = value; }
        }
