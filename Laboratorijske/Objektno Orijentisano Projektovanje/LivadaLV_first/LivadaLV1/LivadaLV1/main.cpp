...
int main()
{
	...
	try
	{
		...
		//Unos prve reci, start za pocetak i autopilot za automatsko ispaljivanje mlazova
		...
		while (Livada::brojPronadjenih < Livada::brojZametaka && !endGame)
		{
		...
		//Prikazivanje skroz otkrivene livade kad otkrijemo sve zametke
		system("cls");
		poljana->OtkrijTablu();
		cout << *poljana;
		cout << "\n =-= >> IGRA JE ZAVRSENA << =-=\n";
